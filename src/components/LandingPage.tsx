          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600">
                These records stay in this browser and do not include an email
                address. Clearing browser data also removes them.
              </p>
            </div>
            {history.length > 0 ? (
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[1.2fr_.8fr] lg:gap-12">
          <section>
            <span className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.14em] text-indigo-700">
              <Sparkles className="h-3.5 w-3.5" aria-hidden="true" /> Private
              beta
            </span>
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600 md:text-lg">
              Tri-Ad is a 30-scenario reflective assessment that produces one of
              18 symbolic cognitive archetypes, eight trait scores, and three
              broader dimensions.
            </p>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                [
                  "30 scenarios",
                  "Choose the response closest to your natural first move.",
                ],
                [
                  "Local-first",
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-5">
              <div>
                ...
                <p className="mt-1.5 text-xs text-slate-500">
                  Use a nickname if you prefer. Email is not required for the
                  assessment.
                </p>
              </div>
              ...
              <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-3">
                ...
                <span>
                  ...
                  <span className="mt-0.5 block text-xs leading-relaxed text-slate-500">
                    Stores the nickname and scores in browser storage. You can
                    delete or export them at any time.
                  </span>
                </span>
              </label>
